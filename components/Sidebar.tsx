    ...
    <aside style={{
      ...
      <div style={{ padding: '20px 18px 16px', borderBottom: `1px solid ${t.border}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div className="font-title" style={{ fontSize: 15, color: t.texte }}>
              {restaurant || 'GestionResto'}
            </div>
            <div style={{ fontSize: 10, color: t.texteFaible, letterSpacing: '0.08em', textTransform: 'uppercase', marginTop: 1 }}>
      ...
      <div style={{ padding: '12px 18px 18px', borderTop: `1px solid ${t.border}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button onClick={handleLogout} style={{
            ...
            color: t.texteFaible, fontSize: 16, lineHeight: 1,
            transition: 'color var(--transition)',
